    ...
    return (
        <div className="max-w-4xl mx-auto relative z-10 -mt-8">
            ...
            <div className={cn(containerClass, mobileStackClass)}>
                ...
                <button
                    onClick={handleGo}
                    className="bg-primary hover:bg-blue-600 text-white min-w-[3.5rem] md:px-8 py-3 rounded-xl font-black md:text-lg transition-all flex items-center justify-center space-x-2 group whitespace-nowrap shadow-lg hover:shadow-blue-500/25 active:scale-[0.98]"
                >
                    <span>GO</span>
