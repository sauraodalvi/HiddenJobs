                    ...
                    <div className="space-y-6">
                        <div className="p-6 rounded-2xl bg-slate-900 text-white shadow-2xl relative overflow-hidden group">
                            <div className="relative z-10">
                                ...
                                <div className="font-mono text-sm bg-black/30 p-4 rounded-xl mb-6 break-all line-clamp-3 group-hover:line-clamp-none transition-all">
                                    {dork}
                                </div>
                                <a
                                    href={googleUrl}
                                    ...
                                    className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg"
                                >
                                    View Live Results
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-6 rounded-2xl border border-slate-200 dark:border-slate-700 hover:border-primary/50 transition-colors">
                                <h4 className="font-bold mb-2">Why {platform.label}?</h4>
                                <p className="text-sm text-slate-500">Most high-growth companies use {platform.label} exclusively. Searching it directly bypasses 90% of your competition.</p>
                            </div>
                            <div className="p-6 rounded-2xl border border-slate-200 dark:border-slate-700 hover:border-primary/50 transition-colors">
                                <h4 className="font-bold mb-2">Verified {location.label}</h4>
                                <p className="text-sm text-slate-500">Filtered for local and remote-first companies hiring specifically for {location.label} based talent.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-wrap gap-3">
                        {DIRECTORY_LOCATIONS.map(loc => (
                            <Link
                                ...
                                className="px-5 py-2.5 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm font-medium hover:border-primary hover:text-primary transition-all shadow-sm"
                            >
                                {loc.label}
                            </Link>
                        ))}
