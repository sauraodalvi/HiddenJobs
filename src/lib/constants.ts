...
export const DIRECTORY_LOCATIONS = [
  ...
  // North America
  { slug: 'san-francisco', label: 'San Francisco', coords: { lat: 37.7749, lng: -122.4194 } },
  { slug: 'new-york', label: 'New York', coords: { lat: 40.7128, lng: -74.0060 } },
  { slug: 'seattle', label: 'Seattle', coords: { lat: 47.6062, lng: -122.3321 } },
  { slug: 'austin', label: 'Austin', coords: { lat: 30.2672, lng: -97.7431 } },
  { slug: 'boston', label: 'Boston', coords: { lat: 42.3601, lng: -71.0589 } },
  ...
  { slug: 'toronto', label: 'Toronto', coords: { lat: 43.6532, lng: -79.3832 } },

  // Europe
  { slug: 'london', label: 'London', coords: { lat: 51.5074, lng: -0.1278 } },
  { slug: 'paris', label: 'Paris', coords: { lat: 48.8566, lng: 2.3522 } },
  { slug: 'berlin', label: 'Berlin', coords: { lat: 52.5200, lng: 13.4050 } },
  { slug: 'amsterdam', label: 'Amsterdam', coords: { lat: 52.3676, lng: 4.9041 } },
  { slug: 'dublin', label: 'Dublin', coords: { lat: 53.3498, lng: -6.2603 } },
  { slug: 'stockholm', label: 'Stockholm', coords: { lat: 59.3293, lng: 18.0686 } },
  { slug: 'zurich', label: 'Zurich', coords: { lat: 47.3769, lng: 8.5417 } },
  { slug: 'madrid', label: 'Madrid', coords: { lat: 40.4168, lng: -3.7038 } },

  // Asia / Oceania
  { slug: 'bangalore', label: 'Bangalore', coords: { lat: 12.9716, lng: 77.5946 } },
  { slug: 'pune', label: 'Pune', coords: { lat: 18.5204, lng: 73.8567 } },
  { slug: 'mumbai', label: 'Mumbai', coords: { lat: 19.0760, lng: 72.8777 } },
  { slug: 'delhi', label: 'Delhi', coords: { lat: 28.6139, lng: 77.2090 } },
  { slug: 'hyderabad', label: 'Hyderabad', coords: { lat: 17.3850, lng: 78.4867 } },
  { slug: 'chennai', label: 'Chennai', coords: { lat: 13.0827, lng: 80.2707 } },
  { slug: 'singapore', label: 'Singapore', coords: { lat: 1.3521, lng: 103.8198 } },
  { slug: 'tokyo', label: 'Tokyo', coords: { lat: 35.6762, lng: 139.6503 } },
